...
<body>
	<h1>Beautiful GateWay Protocole V2</h1>
	...
	<script>
		...
		function onFormSubmit(event) {
			...
			//utilise AngularJS pour nettoyer le commentaire en utilisant "angular.element('<div>').text(comment).html();" pour échapper les caractères potentiellement dangereux. Le commentaire nettoyé est stocké dans la variable "sanitizedComment"
			var sanitizedComment = angular.element('<div>').text(comment).html();
			...
			cell.innerHTML = sanitizedComment;
